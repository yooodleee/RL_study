...
class VPG(BatchPolopt, Serializable):
    ...
    def init_opt(self):
        ...
        advantage_var = tensor_utils.new_tensor(
            name='advantage', ndim=1 + is_recurrent, dtype=tf.float32
        )
        ...
        old_dist_info_vars_list = [old_dist_info_vars[k] for k in dist.dist_infokeys]
        ...
        # formulate as a minization problem
