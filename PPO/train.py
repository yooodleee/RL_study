...
import uuid
import yaml
# from __future__ import annotations  # 타입 힌트를 문자열로 평가
...
def load_experiments_from_file(
    ...
    Args:
        ...
        file_type: One value of the 'SupportFileType' enum (yaml or python).
        ...
        experiments={
            experiment_name: {  # i.e. log to ~/ray_results/default
                ...
                "checkpoint_config": {
                    ...
                    "checkpoint_at_end": checkpoint_at_end,
                    "num_to_keep": keep_checkpoints_num,
                    "checkpoint_score_attrigute": checkpoint_score_attr,
                },
...
def _run_rllib_experiments(
    ...
    for exp in experiments.values():
        ...
        if vv:
            ...
            verbose=3   # Print details on trail result
    ...
    # Run the Tune experiment and return the trails.
    ...
    if checkpoints:
        ...
        print(
            "\nYour can now evaluate your trained algorithm from any "
