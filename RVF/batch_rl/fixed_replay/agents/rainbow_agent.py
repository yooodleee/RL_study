...
class FixedReplayRainbowAgent(rainbow_agent.RainbowAgent):
    ...
    def __init__(
        ...
        replay_data_dir: (str)
            log Directory from which to load the replay buffer.
        replay_suffix: (int)
        ...
        init_checkpoint_dir: (str)
            directory from which initial checkpoint before training is 
            loaded if there doesn't exist any checkpoint in the current
        ...
        **kwargs: 
        ...
        super(
            FixedReplayRainbowAgent, self
        ).__init__(sess, num_actions, **kwargs)
