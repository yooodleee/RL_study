...
def from_logits(
    ...
    Calculates V-trace actor critic targets for softmax policies as described in
    ...
    Args:
        behaviour_policy_logits: A float32 tensor of shape [T, B, NUM_ACTIONS] with
            ...
            policy.
        target_policy_logtis: A float32 tensor of shape [T, B, NUM_ACTIONS] with 
    ...
    Returs:
        A 'VTraceFromLogitsReturns' namedtuple with the following fields:
            ...
            pg_advantages: A float32 tensor of shape [T, B]. can be used as an
                estimate of the advantage in the calcaulation of policy gradients.
...
def from_importance_weights(
    ...
    Args:
        log_rhos: A float32 tensor of shape [T, B, NUM_ACTIONS] representing the log
            ...
            or rhos in log-space for numerical stability.
        ...
        clip_pg_rho_threshold: A scalar float32 tensor with the clipping threshold
            on rho_s in \rho_s \delta log \pi(a|x) (r + \gamma v_{s+1} - V{t_s}). If
