...
setup(
    ...
    description='OpenAI baselines: high quality implementation of reinforcement learning algorithms',
    author='OpenAI',
...
# eunsure there is some tensorflow build with version above 1.4
