...
if __name__ == "__main__":
    ...
    const_schedule=utils.ConstSchedule(epsilon_eval)    # lambda would als do - doing it like this for consistency
    ...
    dqn=DQN(env, number_of_actions=env.action_space.n, epsilon_shcedule=const_schedule).to(device)
    ...
    while True:
        ...
        current_state=replay_buffer.fatch_last_state()  # fetch the state, shape = (4, 84, 84) for Atari
        ...
        last_frame=new_frame    # see the last frame to the newly acquired frame from the env
