...
import torch
from .replay_memory import Memory, Trasition
...
class SACAgent:
    ...
    def train(self):
        if len(self.memory) < self.batch_size:
            ...
            reparam_actions, log_probs = self.policy_network.sample_of_likelihood(states)
            ...
            discriminator_loss = self.cross_ent_loss(logits, zs.unsqueeze(-1))
