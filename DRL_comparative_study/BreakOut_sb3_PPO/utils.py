...
class RewardLogger(gym.Wrapper):
    ...
    # The rest function is called every time the environment is reset (at the beginning of each episode)
...
class CustomWandbCallback(BaseCallback):
    ...
    def _on_step(self)-> bool:
        ...
        '''
        # Check the number of calls to callback is a multiple of the check_freq
