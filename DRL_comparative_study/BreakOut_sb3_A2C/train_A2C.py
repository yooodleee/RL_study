...
understand the parameters of the midel, go to config.py and read the comments of each parameter.
'''
...
from gymnasium.wrappers import RecordVideo  # 추가 코드(gymnasium.wrappers.monitoring 모듈이 변경되었거나 제거됨)
import torch 
import config
import wandb
...
'''
# model.learn will train the model for 1e6 timesteps, timestep is the number of actions taken bt the agent,
