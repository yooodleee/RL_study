...
class RewardLogger(gym.Wrapper):
    ...
    def step(self, action):
        ...
        Output:
            obs (np.ndarry): The observation of the environment after taking the action the shape of the observation is (1, 84, 84)
...
class CustomWandbCallback(BaseCallback):
    ...
    def _on_step(self)-> bool:
        ...
        '''
        # Chek if the number of calls to the callback is a multiple of the check_freq
        if self.n_calls % self.check_freq == 0:
            ...
            for env in self.training_env.envs:  # self.training_env is the vectorized environment
                ...
                if isinstance(logger_env, RewardLogger):
                    ...
                    all_rewards.append(logger_env.get_episode_rewards())    # extend is used to add the elements of a list to another list
