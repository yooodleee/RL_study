...
if config.log_to_wandb:
    ...
    # this is doen because wandb.watch() does not work with sb3
...
# go to config.py to see the meaning of each parameters in detail
model = DQN(policy=config.policy,
            ...
            exploration_initial_eps=config.explration_initial_eps,
...
# callback is a callback that logs the training process to wandb, this is 
# done because wandb.watch() does not work with sb3
