...
if config.log_to_wandb:
    ...
    # wandb_callback is a callback that logs the training process to wandb, this is doen because wandb.watch() does not work with sb3
...
Set up the model
'''
# Create the model with the parameters specified in config.py, go to config.py to see the meaning of each parameters in detail
...
if config.pretrained:
    ...
    # Unzip the file a2c_Breakout_1M.zip and sotre the unzipped files in the folder DQN_Breakout_unzipped
