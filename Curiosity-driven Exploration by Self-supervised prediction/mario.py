"""
Script to test if mario installation works fine.
It displays the game play simultaneously.
"""
...
while(1):
    ...
    Image.fromarray((255*obs).astype('unit8')).save(outputdir + '/ep_%02d/%06d.jpg'%(episodes+1, imCount))
    imCount += 1
    if done:
        episodes += 1
