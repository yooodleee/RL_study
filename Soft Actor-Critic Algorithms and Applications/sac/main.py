...
parser.add_argument("--tau", type=float, default=0.005, metavar="G", help="target smoothing coefficient(t) (default: 0.005)")
parser.add_argument("--lr", type=float, default=0.0003, metavar="G", help="learning rate (default: 0.0003)")
parser.add_argument("--alpha", type=float, default=0.2, metavar="G",
                    help="Temparature parameter a determines the relative importance of the entropy term against the reward (default: 0.2)")
parser.add_argument("--automatic_entropy_tuning", type=bool, default=False, metavar="G",
                    help="Automatically adjust a (default: False)")
parser.add_argument("--seed", type=int, default=123456, metavar="N", help="random seed (default: 123456)")
parser.add_argument("--batch_size", type=int, default=256, metavar="N", help="batch size (default: 256)")
parser.add_argument("--num_steps", type=int, default=1000001, metavar="N", help="maximum number of steps (default: 1000001)")
...
# Tensorboard
writer=summary("runs/{}_SAC_{}_{}_{}".format(datetime.datetime.now().strftime("%Y-%m-%d-%H-%M-%S"), args.env_name,
                                                    args.policy, "autotime" if args.automatic_entropy_tuning else ""))
    ...
    while not done:
        ...
        if len(memory) > args.batch_size:
            ...
            for i in range(args.updates_per_step):
                ...
                writer.add_scalar("entropy_temparature/alpha", alpha, updates)
                updates += 1
