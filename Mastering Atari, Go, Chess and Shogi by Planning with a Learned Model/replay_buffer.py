...
class ReplayBuffer:
    ...
    def update_priorities(self, priorities, index_info):
        """Update game and position priorities wit priorities calculated during the training.
...
class Reanalyse:
    ...
    def reanalyse(self, replay_buffer, shared_storage):
        ...
        while ray.get(
            ...
            # Use the last model to provide a fresher, stable n-step value (See paper appendix Reanalze)
